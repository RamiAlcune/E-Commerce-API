...
import { getAllUsers, getUserByID, updateUser, showCurrentUser, updateUserPassword } from "../controllers/userController";
...
UsersRoute.post("/changePassword", authenticateUser as RequestHandler, authorizePermissions("user", "admin"), updateUserPassword);
